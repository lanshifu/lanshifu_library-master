...
public class PopMenu {
    ...
    private OnPopMenuItemClickListener mPopMenuItemListener;
    ...
    private void buildAnimateGridLayout() {
        ...
        mCloseIv.setImageResource(R.drawable.delete_icon);
    ...
    private void showSubMenus(ViewGroup viewGroup) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            animateViewDirection(view, mScreenHeight, -100, mTension, mFriction);
        }
    }
    ...
    public static class Builder {
        ...
        private OnPopMenuItemClickListener popMenuItemListener;
        ...
        public Builder setOnPopMenuItemListener(OnPopMenuItemClickListener listener) {
