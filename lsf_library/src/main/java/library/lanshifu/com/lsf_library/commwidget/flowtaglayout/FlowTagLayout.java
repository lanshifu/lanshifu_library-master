...
//            }
            ...
            childView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        ...
                        mCheckedTagArray.put(j, !mCheckedTagArray.get(j));
                        childView.setSelected(mCheckedTagArray.get(j));
    ...
    public void setCheckItem(Integer... select) {
        ...
        if (mAdapter.getCount() > 0) {
            ...
            for (int j = 0; j < select.length; j++) {
                Integer selectitem = select[j];
                mCheckedTagArray.put(selectitem, true);
                View childView = mAdapter.getView(j, null, this);
                childView.setSelected(true);
            }
