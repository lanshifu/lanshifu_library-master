package library.lanshifu.com.lsf_library.commwidget.autoscrolltoplayout;
...
import library.lanshifu.com.lsf_library.utils.DensityUtil;
 ...
 */
public class AutoScrollToTopLayout extends FrameLayout {
    ...
    public AutoScrollToTopLayout(@NonNull Context context) {
        super(context);
        init(context, null, 0);
    }

    public AutoScrollToTopLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public AutoScrollToTopLayout(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attr = context.obtainStyledAttributes(attrs, R.styleable.AutoScrollToTopLayout, defStyleAttr, 0);
        mShowScroll = attr.getBoolean(R.styleable.AutoScrollToTopLayout_show_scroll, true);
        int showAnimResourceId = attr.getResourceId(R.styleable.AutoScrollToTopLayout_show_animation, R.anim.fab_scale_up);
        mShowAnimation = AnimationUtils.loadAnimation(getContext(), showAnimResourceId);
        int hideAnimResourceId = attr.getResourceId(R.styleable.AutoScrollToTopLayout_hide_animation, R.anim.fab_scale_down);
        mHideAnimation = AnimationUtils.loadAnimation(getContext(), hideAnimResourceId);
        scroll_gravity = attr.getInt(R.styleable.AutoScrollToTopLayout_scroll_gravity, Gravity.BOTTOM | Gravity.CENTER_HORIZONTAL);
        showScrollDistance = attr.getDimensionPixelSize(R.styleable.AutoScrollToTopLayout_scroll_distance, 100);
        arrowIcon = attr.getResourceId(R.styleable.AutoScrollToTopLayout_auto_arrow_icon, R.mipmap.go_top);
        attr.recycle();
    ...
    private void attachScrollBackView() {
        ...
        if (mShowScroll) {
            ...
            params.bottomMargin = DensityUtil.dp2px(16f);
