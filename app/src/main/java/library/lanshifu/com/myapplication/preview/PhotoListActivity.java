...
import library.lanshifu.com.myapplication.preview.enitity.UserViewInfo;
...
public class PhotoListActivity extends BaseToolBarActivity {
    ...
    protected void onViewCreate() {
        ...
        for (String string : imageArray) {
            list.add(string);
            mThumbViewInfoList.add(new UserViewInfo(string));

        }
        mGridLayoutManager = new GridLayoutManager(mContext, 2);
        mCommRecyclerView.setLayoutManager(mGridLayoutManager);
        BaseQuickAdapter<String, BaseViewHolder> adapter = new BaseQuickAdapter<String, BaseViewHolder>(R.layout.list_item_image, list) {
            @Override
        ...
        mCommRecyclerView.setAdapter(adapter);
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                computeBoundsBackward(mGridLayoutManager.findFirstVisibleItemPosition());
                GPreviewBuilder.from(PhotoListActivity.this)
    ...
    private void computeBoundsBackward(int firstCompletelyVisiblePos) {
        for (int i = firstCompletelyVisiblePos;i < mThumbViewInfoList.size(); i++) {
            ...
            if (itemView != null) {
                ImageView thumbView = (ImageView) itemView.findViewById(R.id.iv_img);
