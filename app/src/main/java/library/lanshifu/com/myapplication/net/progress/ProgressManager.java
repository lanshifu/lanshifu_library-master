...
import library.lanshifu.com.myapplication.net.progress.body.ProgressRequestBody;
import library.lanshifu.com.myapplication.net.progress.body.ProgressResponseBody;
...
public final class ProgressManager {
    ...
    /**
     * 因为 {@link WeakHashMap} 将 {@code key} 作为弱键 (弱引用的键), 所以当 java 虚拟机 GC 时会将某个不在被引用的 {@code key}
     * 回收并加入 {@link ReferenceQueue}
