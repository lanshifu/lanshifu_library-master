package library.lanshifu.com.myapplication.preview.wight;
...
public class SmoothImageView extends PhotoView {
    ...
    private void initTransform() {
        ...
        startTransform.top = thumbRect.top - StatusBarCompat.getStatusBarHeight(getContext().getApplicationContext());
