...
public class CardSlideViewActivity extends BaseToolBarActivity {
    ...
    protected int getLayoutid() {
        return R.layout.activity_card_slide_view;
    }

    @Override
    protected void onViewCreate() {
        CardViewPager cardViewPager = (CardViewPager) findViewById(R.id.card_ViewPager);
        cardViewPager.bind(getSupportFragmentManager(),new MyCardHandler(), Arrays.asList(imageArray));
    ...
    class MyCardHandler implements CardHandler<String>{
        ...
        public View onBind(final Context context, final String data, final int position) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showShortToast("data:" + data + "position:" + position);
                }
            });
            return view;
        }
