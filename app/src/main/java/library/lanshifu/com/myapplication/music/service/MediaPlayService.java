package library.lanshifu.com.myapplication.music.service;
...
public class MediaPlayService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        mediaPlayer = getMediaPlayer(MyApp.getContext());
     ...
     * 播放
     */
    public void playSong(SongDetailInfo info, boolean isLocal) {
...
//    }
    ...
    private void play(String musicUrl, boolean isLocal) {
        ...
        if (!NetworkUtils.isNetworkAvailable(MyApp.getContext())) {
            if (!isLocal) {
                Toast.makeText(MyApp.getContext(), "没有网络了哟，请检查网络设置", Toast.LENGTH_SHORT).show();
            }
        }
...
//        updatePlayingUI(mSongDetailInfo);
    ...
    int my_notice_id = 111;

    protected void notice() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this);
        builder.setSmallIcon(R.mipmap.ic_launcher);
        builder.setContentTitle("音乐");
        builder.setContentText("当前播放");
        //设置点击通知跳转页面后，通知消失
        builder.setAutoCancel(true);
        Intent intent = new Intent(this, MusicSongListDetailActivity.class);
